...
<body>
    ...
    <div class="container-fluid mx-2">
        <h4 class="my-3 navy">Formulir Pengembalian Barang ke Gudang</h4>
        <div class="row">
            <div class="col-md-5">
                <div class="card rounded-0">
                    <div class="card-body">
                        <form action="<?= base_url() . 'pengeluaran/add_to_cart_opsional' ?>" method="POST">
                                ...
                                <tbody>
                                    ...
                                    foreach ($this->cart->contents() as $items) : ?>
                                        <tr>
                                            ...
                                            <td class="align-items-middle text-center"><a href="<?php echo base_url() . 'pengeluaran/remove_data/' . $items['rowid']; ?>" class="btn btn-info btn-sm"><span class="fa fa-close"></span> Batal</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                            <a href="<?php echo base_url() . 'pengeluaran/pengeluaran_opsional' ?>" class=" btn btn-primary btn-sm"><span class="fa fa-save"></span> Simpan</a>
                        </div>
                    </div>
                </div>
            </div>
