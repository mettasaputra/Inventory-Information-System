    ...
    <div class="row my-5">
        ...
        <div class="col-md-6 align-self-center">
            <div class="container">
                ...
                <h2 class="text-primary">OH! You're lost.</h2>
                <div class="lead text-justify">Halaman yang Anda cari tidak ditemukan.
                    Bagaimana Anda sampai ke halaman ini merupakan misteri.
                    Namun Anda bisa kembali ke Homepage dengan meng-klik tombol dibawah ini!
                </div>
                <a class="btn btn-primary btn-sm mt-2" href="/portal">Kampoeng Kayoe's Portal</a>
