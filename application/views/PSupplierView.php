                                ...
                                <div class="col-sm-8">
                                    <select name="sup" class="form-control" name="sup" value="<?= $this->session->userdata('sup') ?>">
                                        ...
                                        foreach ($supplier->result_array() as $sup) :
                                            $id = $sup['id_supplier'];
                                            $nm = $sup['nama_supplier'];
                                        ?>
                                            <?php if ($this->session->userdata('sup') == $id) : ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($this->cart->contents() as $items) : ?>
                                        <tr>
                                            ...
                                            <td class="align-items-middle text-center"><a href="<?php echo base_url() . 'penerimaan/remove/' . $items['rowid']; ?>" class="btn btn-info btn-sm"><span class="fa fa-close"></span> Batal</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                            <a href="<?php echo base_url() . 'penerimaan/penerimaan_supplier' ?>" class=" btn btn-primary btn-sm"><span class="fa fa-save"></span> Simpan</a>
                        </div>
                    </div>
                </div>
            </div>
