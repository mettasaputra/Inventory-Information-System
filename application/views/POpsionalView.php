...
<body>
    ...
    <div class="container-fluid mx-2">
        <h4 class="my-3">Formulir Penerimaan Barang Lain-Lain</h4>
        <div class="row">
            <div class="col-md-5">
                <div class="card rounded-0">
                    <div class="card-body">
                        <form action="<?= base_url() . 'penerimaan/add_to_cart_opsional' ?>" method="POST">
                                ...
                                <tbody>
                                    ...
                                    foreach ($this->cart->contents() as $items) : ?>
                                        <tr>
                                            ...
                                            <td class="align-items-middle text-center"><a href="<?php echo base_url() . 'penerimaan/remove_data/' . $items['rowid']; ?>" class="btn btn-info btn-sm"><span class="fa fa-close"></span> Batal</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                            <a href="<?php echo base_url() . 'penerimaan/penerimaan_opsional' ?>" class=" btn btn-primary btn-sm"><span class="fa fa-save"></span> Simpan</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#brg").on("select2:select", function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . 'penerimaan/get_detail_barang'; ?>",
                    data: barang,
